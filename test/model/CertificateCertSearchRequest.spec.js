...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('CertificateCertSearchRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.CertificateCertSearchRequest();
      });

      it('should create an instance of CertificateCertSearchRequest', function() {
        // TODO: update the code to test CertificateCertSearchRequest
        expect(instance).to.be.a(OdinApis.CertificateCertSearchRequest);
      });
