...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesHostsSearchDataLocation', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesHostsSearchDataLocation();
      });

      it('should create an instance of IpservicesHostsSearchDataLocation', function() {
        // TODO: update the code to test IpservicesHostsSearchDataLocation
        expect(instance).to.be.a(OdinApis.IpservicesHostsSearchDataLocation);
      });
