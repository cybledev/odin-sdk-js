...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('DnsSearchPagination', function() {
      beforeEach(function() {
        instance = new OdinApis.DnsSearchPagination();
      });

      it('should create an instance of DnsSearchPagination', function() {
        // TODO: update the code to test DnsSearchPagination
        expect(instance).to.be.a(OdinApis.DnsSearchPagination);
      });
