...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('CertificateCertificateSearchResponsePagination', function() {
      beforeEach(function() {
        instance = new OdinApis.CertificateCertificateSearchResponsePagination();
      });

      it('should create an instance of CertificateCertificateSearchResponsePagination', function() {
        // TODO: update the code to test CertificateCertificateSearchResponsePagination
        expect(instance).to.be.a(OdinApis.CertificateCertificateSearchResponsePagination);
      });
