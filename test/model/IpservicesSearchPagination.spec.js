...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesSearchPagination', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesSearchPagination();
      });

      it('should create an instance of IpservicesSearchPagination', function() {
        // TODO: update the code to test IpservicesSearchPagination
        expect(instance).to.be.a(OdinApis.IpservicesSearchPagination);
      });
