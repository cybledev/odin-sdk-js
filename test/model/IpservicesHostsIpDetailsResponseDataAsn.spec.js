...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesHostsIpDetailsResponseDataAsn', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesHostsIpDetailsResponseDataAsn();
      });

      it('should create an instance of IpservicesHostsIpDetailsResponseDataAsn', function() {
        // TODO: update the code to test IpservicesHostsIpDetailsResponseDataAsn
        expect(instance).to.be.a(OdinApis.IpservicesHostsIpDetailsResponseDataAsn);
      });
