...
(function(root, factory) {
  ...
  describe('IPWhois', function() {
    it('should create an instance of IPWhois', function() {
      // uncomment below and update the code to test IPWhois
      //var instance = new Odin.IPWhois();
      //expect(instance).to.be.a(Odin.IPWhois);
    });
