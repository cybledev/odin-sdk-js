...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('DnsAPIResponse', function() {
      beforeEach(function() {
        instance = new OdinApis.DnsAPIResponse();
      });

      it('should create an instance of DnsAPIResponse', function() {
        // TODO: update the code to test DnsAPIResponse
        expect(instance).to.be.a(OdinApis.DnsAPIResponse);
      });
