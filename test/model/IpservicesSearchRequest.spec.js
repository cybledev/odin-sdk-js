...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesSearchRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesSearchRequest();
      });

      it('should create an instance of IpservicesSearchRequest', function() {
        // TODO: update the code to test IpservicesSearchRequest
        expect(instance).to.be.a(OdinApis.IpservicesSearchRequest);
      });
