...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('CertificateCertSummaryRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.CertificateCertSummaryRequest();
      });

      it('should create an instance of CertificateCertSummaryRequest', function() {
        // TODO: update the code to test CertificateCertSummaryRequest
        expect(instance).to.be.a(OdinApis.CertificateCertSummaryRequest);
      });
