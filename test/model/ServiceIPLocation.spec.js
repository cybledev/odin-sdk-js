...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Odin.ServiceIPLocation();
  });
  ...
  describe('ServiceIPLocation', function() {
    it('should create an instance of ServiceIPLocation', function() {
      // uncomment below and update the code to test ServiceIPLocation
      //var instance = new Odin.ServiceIPLocation();
      //expect(instance).to.be.a(Odin.ServiceIPLocation);
    });
