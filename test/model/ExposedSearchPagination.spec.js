...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('ExposedSearchPagination', function() {
      beforeEach(function() {
        instance = new OdinApis.ExposedSearchPagination();
      });

      it('should create an instance of ExposedSearchPagination', function() {
        // TODO: update the code to test ExposedSearchPagination
        expect(instance).to.be.a(OdinApis.ExposedSearchPagination);
      });
