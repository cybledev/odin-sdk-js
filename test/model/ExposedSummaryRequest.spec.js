...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('ExposedSummaryRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.ExposedSummaryRequest();
      });

      it('should create an instance of ExposedSummaryRequest', function() {
        // TODO: update the code to test ExposedSummaryRequest
        expect(instance).to.be.a(OdinApis.ExposedSummaryRequest);
      });
