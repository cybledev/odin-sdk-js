...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesSummaryRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesSummaryRequest();
      });

      it('should create an instance of IpservicesSummaryRequest', function() {
        // TODO: update the code to test IpservicesSummaryRequest
        expect(instance).to.be.a(OdinApis.IpservicesSummaryRequest);
      });
