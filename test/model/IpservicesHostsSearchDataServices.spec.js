...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('IpservicesHostsSearchDataServices', function() {
      beforeEach(function() {
        instance = new OdinApis.IpservicesHostsSearchDataServices();
      });

      it('should create an instance of IpservicesHostsSearchDataServices', function() {
        // TODO: update the code to test IpservicesHostsSearchDataServices
        expect(instance).to.be.a(OdinApis.IpservicesHostsSearchDataServices);
      });
