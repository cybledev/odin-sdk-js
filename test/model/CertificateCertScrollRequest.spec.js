...
(function(root, factory) {
  ...
  describe('odin', function() {
    describe('CertificateCertScrollRequest', function() {
      beforeEach(function() {
        instance = new OdinApis.CertificateCertScrollRequest();
      });

      it('should create an instance of CertificateCertScrollRequest', function() {
        // TODO: update the code to test CertificateCertScrollRequest
        expect(instance).to.be.a(OdinApis.CertificateCertScrollRequest);
      });
