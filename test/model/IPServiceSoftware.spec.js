...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Odin.IPServiceSoftware();
  });
  ...
  describe('IPServiceSoftware', function() {
    it('should create an instance of IPServiceSoftware', function() {
      // uncomment below and update the code to test IPServiceSoftware
      //var instance = new Odin.IPServiceSoftware();
      //expect(instance).to.be.a(Odin.IPServiceSoftware);
    });
